var unityWebView =
{
    ...
    init : function (name) {
        ...
        if ($containers.length === 0) {
            $('<div id="webviewMain" style="position: absolute; left: 0px; width: 100%; height: 100%; top: 0px; pointer-events: none;"><div class="webviewContainer" style="overflow: hidden; position: relative; width: 100%; height: 100%; z-index: 1;"></div></div>')
                .appendTo($('#webview-container'));
        }
    ...
    setQuestionString: function (name,question){
        //console.log(question);  
        this.iframe(name).contents().find('#question-body').html(question);
    },

    setAbsoluteSize: function (name, leftPercent, topPercent, widthPercent, heightPercent) {
        //
        this.iframe(name)
    ...
    onResizeCallFromJs: function(){
        unityInstance.SendMessage("JsHook", "onBrowserResize");
    },
};
